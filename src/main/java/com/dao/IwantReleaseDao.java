...
public class IwantReleaseDao {
    ...
    //黑榜曝光表(C_POST_BAR_11)
    public int saveHbbgfo(String recordId, String userId, int cheatType, String belongQf, String tixin, String roleName, String cheatIntro, String cheatInfo, String pageUrl) throws Exception {
        ...
        sql.append("INSERT INTO `grab`.`c_post_bar_11` (`RECORD_ID`, `CREATETIME`, `UPDATETIME`, `ISVALID`, `USER_ID`, `FAVOR_DATE`, `CHEAT_TYPE`, `BELONG_QF`, " +
                "`TIXIN`, `ROLE_NAME`, `CHEAT_INTRO`, `CHEAT_INFO`, `PAGE_URL`, `MAIN_ID`) " +
                "VALUES ('"+recordId+"','"+createTime+"','"+createTime+"','1','"+userId+"','"+favorDate+"','"+cheatType+"','"+belongQf+"','"+tixin+"'," +
    ...
    public int saveZhjyxxInfo(String recordId, String belongQf,String tixin,int priceNum,String accoInfo) throws Exception {
        StringBuilder sql = new StringBuilder();
        List<Object> paramList = new ArrayList<Object>();
        String createTime =  new MyDateTimeUtils().DateTimeToStr(new Date(), "yyyy-MM-dd hh:mm:ss").replace("s*","");
        String userId = "1";
        String tradeType = "1";
        String favorDate = createTime;
        String REPLY_TIME = createTime;String REPLY_CONTENT = "";String BELONG_FLOOR = "1";String PAGE_NUM = "1";String PAGE_URL = "";String URL_VALID = "1";String MAIN_ID = "1";String SOURCE_TYPE = "1";String MENPAI_NAME = "";String XINFA_NAME = "";String TITLE_NAME = "";
        ...
        sql.append(" INSERT INTO `grab`.`c_post_bar_12` (`RECORD_ID`, `CREATETIME`, `UPDATETIME`, `ISVALID`, `TRADE_TYPE`, `BELONG_QF`, `TIXIN`, `PRICE_NUM`, " +
                ...
                "VALUES ('"+recordId+"','"+createTime+"','"+createTime+"','1', '"+tradeType+"', '"+belongQf+"', '"+tixin+"', '"+priceNum+"', " +
    ...
    public int saveWgjyxxInfo(String recordId, String userId, int tradeType, String belongQf, String viewName, int priceNum, String favorInfo) throws Exception {
        StringBuilder sql = new StringBuilder();
        List<Object> paramList = new ArrayList<Object>();
        String createTime =  new MyDateTimeUtils().DateTimeToStr(new Date(), "yyyy-MM-dd hh:mm:ss").replace("\\s*","");
        String favorId = "2";
        ...
        sql.append(" INSERT INTO `grab`.`c_post_bar_13` (`RECORD_ID`, `CREATETIME`, `UPDATETIME`, `ISVALID`, `THEME_ID`, `PAGE_URL`, `POST_BAR`, `POST_ID`, " +
                ...
                "VALUES ('"+recordId+"','"+createTime+"','"+createTime+"','1', '"+THEME_ID+"', '"+PAGE_URL+"', '"+POST_BAR+"', '"+POST_ID+"', " +
    ...
    public int saveDjjyxxInfo(String recordId, String userId, int tradeType, String belongQf, String propName, int priceNum, String favorInfo) throws Exception {
        StringBuilder sql = new StringBuilder();
        List<Object> paramList = new ArrayList<Object>();
        String createTime =  new MyDateTimeUtils().DateTimeToStr(new Date(), "yyyy-MM-dd hh:mm:ss").replace("\\s*","");
        String favorDate = createTime;
        ...
        sql.append(" INSERT INTO `grab`.`c_post_bar_15` (`RECORD_ID`, `CREATETIME`, `UPDATETIME`, `ISVALID`, `THEME_ID`, `PAGE_URL`, `POST_BAR`, `POST_ID`, " +
    ...
    public int saveYxjbjyInfo(String recordId, String userId, int tradeType, String belongQf, int goldTotal, int unitPrice, int ifSplit, String favorInfo) throws Exception {
        StringBuilder sql = new StringBuilder();
        List<Object> paramList = new ArrayList<Object>();
        String createTime =  new MyDateTimeUtils().DateTimeToStr(new Date(), "yyyy-MM-dd hh:mm:ss").replace("\\s*","");
        String favorDate = createTime;
        ...
        sql.append(" INSERT INTO `grab`.`c_post_bar_19` (`RECORD_ID`, `CREATETIME`, `UPDATETIME`, `ISVALID`, `USER_ID`, `FAVOR_DATE`, `TRADE_TYPE`, `BELONG_QF`, " +
                "`GOLD_TOTAL`, `UNIT_PRICE`, `IF_SPLIT`, `MAIN_ID`) " +
                "VALUES ('"+recordId+"','"+createTime+"','"+createTime+"','1','"+userId+"','"+favorDate+"','"+tradeType+"','"+belongQf+"', " +
    ...
    public int saveYxddxxInfo(String recordId, String userId, int cheatType, String belongQf, String favorInfo) throws Exception {
        StringBuilder sql = new StringBuilder();
        List<Object> paramList = new ArrayList<Object>();
        String createTime =  new MyDateTimeUtils().DateTimeToStr(new Date(), "yyyy-MM-dd hh:mm:ss").replace("\\s*","");
        String favorId = "2";
        ...
        sql.append(" INSERT INTO `grab`.`c_post_bar_17` (`RECORD_ID`, `CREATETIME`, `UPDATETIME`, `ISVALID`, `USER_ID`, `NEED_TYPE`, `POST_CONTENT`, " +
                "`REPLY_TIME`, `BELONG_QF`, `THEME_ID`, `PAGE_URL`, `POST_BAR`, `POST_ID`, `POST_BAR_CLASS`, `BELONG_FLOOR`, `PAGE_NUM`, `THEME_NAME`, `MAIN_ID`) " +
                "VALUES ('"+recordId+"','"+createTime+"','"+createTime+"','1','"+userId+"', '"+cheatType+"', '"+favorInfo+"', " +
...
//--------------------------------------------------------------------------------------
    ...
    public int saveWyjbInfo(String recordId, String userId, int cheatType, String belongQf, String tixin, String roleName, String cheatIntro, String cheatInfo, String pageUrl) throws Exception {
        StringBuilder sql = new StringBuilder();
        List<Object> paramList = new ArrayList<Object>();
        String createTime =  new MyDateTimeUtils().DateTimeToStr(new Date(), "yyyy-MM-dd hh:mm:ss").replace("\\s*","");

        String favorDate = createTime;
        sql.append(" insert into D_POST_BAR_11(record_id,createtime,updatetime,isvalid,user_id,favor_date,cheat_type,belong_qf,tixin,role_name,cheat_intro,cheat_info,page_url) " +
                " VAlUES('"+recordId+"','"+createTime+"','"+createTime+"','1','"+userId+"','"+favorDate+"','"+cheatType+"','"+belongQf+"','"+tixin+"','"+roleName+"','"+cheatIntro+"','"+cheatInfo+"','"+pageUrl+"')");
        System.out.println(sql);
        return this.commondao.update(sql.toString(), paramList);
    }

    //外观交易(D_POST_BAR_16--C_POST_BAR_13)
    public int saveWgjyInfo(String recordId, String userId, int tradeType, String belongQf, String viewName, int priceNum, String favorInfo) throws Exception {
        StringBuilder sql = new StringBuilder();
        List<Object> paramList = new ArrayList<Object>();
        String createTime =  new MyDateTimeUtils().DateTimeToStr(new Date(), "yyyy-MM-dd hh:mm:ss").replace("\\s*","");
        String favorDate = createTime;
        sql.append(" insert into D_POST_BAR_16(record_id,createtime,updatetime,isvalid,user_id,trade_type,belong_qf,view_name,price_num,favor_date,favor_info) " +
                " VAlUES('"+recordId+"','"+createTime+"','"+createTime+"','1','"+userId+"','"+tradeType+"','"+belongQf+"','"+viewName+"','"+priceNum+"','"+favorDate+"','"+favorInfo+"')");
        System.out.println(sql);
        return this.commondao.update(sql.toString(), paramList);
    }

    //道具交易(D_POST_BAR_18-C_POST_BAR_15)
    public int saveDjjyInfo(String recordId, String userId, int tradeType, String belongQf, String propName, int priceNum, String favorInfo) throws Exception {
        StringBuilder sql = new StringBuilder();
        List<Object> paramList = new ArrayList<Object>();
        String createTime =  new MyDateTimeUtils().DateTimeToStr(new Date(), "yyyy-MM-dd hh:mm:ss").replace("\\s*","");
        String favorDate = createTime;
        sql.append(" insert into D_POST_BAR_18(record_id,createtime,updatetime,isvalid,user_id,trade_type,belong_qf,prop_name,price_num,favor_info,favor_date) " +
                " VAlUES('"+recordId+"','"+createTime+"','"+createTime+"','1','"+userId+"','"+tradeType+"','"+belongQf+"','"+propName+"','"+priceNum+"','"+favorInfo+"','"+favorDate+"')");
        System.out.println(sql);
        return this.commondao.update(sql.toString(), paramList);
    }

    //金币交易(D_POST_BAR_19--C_POST_BAR_19)
    public int saveJbjyInfo(String recordId, String userId, int tradeType, String belongQf, int goldTotal, int unitPrice, int ifSplit, String favorInfo) throws Exception {
        StringBuilder sql = new StringBuilder();
        List<Object> paramList = new ArrayList<Object>();
        String createTime =  new MyDateTimeUtils().DateTimeToStr(new Date(), "yyyy-MM-dd hh:mm:ss").replace("\\s*","");
        String favorId = "2";
        String favorDate = createTime;
        sql.append(" insert into D_POST_BAR_19(record_id,createtime,updatetime,isvalid,user_id,favor_date,trade_type,belong_qf,gold_total,unit_price,if_split,favor_info) " +
                " VAlUES('"+recordId+"','"+createTime+"','"+createTime+"','1','"+userId+"','"+favorDate+"','"+tradeType+"','"+belongQf+"','"+goldTotal+"','"+unitPrice+"','"+ifSplit+"','"+favorInfo+"')");
        System.out.println(sql);
        return this.commondao.update(sql.toString(), paramList);
    }

    //代练代打(D_POST_BAR_20--C_POST_BAR_17)
    public int saveDlddInfo(String recordId, String userId, int needType, String belongQf, String favorInfo) throws Exception {
        StringBuilder sql = new StringBuilder();
        List<Object> paramList = new ArrayList<Object>();
        String createTime =  new MyDateTimeUtils().DateTimeToStr(new Date(), "yyyy-MM-dd hh:mm:ss").replace("\\s*","");
        String favorDate = createTime;
        sql.append(" insert into D_POST_BAR_20(record_id,createtime,updatetime,isvalid,user_id,need_type,belong_qf,favor_info,favor_Date) " +
                " VAlUES('"+recordId+"','"+createTime+"','"+createTime+"','1','"+userId+"','"+needType+"','"+belongQf+"','"+favorInfo+"','"+favorDate+"')");
        System.out.println(sql);
        return this.commondao.update(sql.toString(), paramList);
    }

    //账号快售快速发布(D_POST_BAR_13--C_POST_BAR_12)
    public int saveZhssInfo(String recordId, String belongQf,String tixin,int priceNum,String accoInfo) throws Exception {
        StringBuilder sql = new StringBuilder();
        List<Object> paramList = new ArrayList<Object>();
        String createTime =  new MyDateTimeUtils().DateTimeToStr(new Date(), "yyyy-MM-dd hh:mm:ss").replace("\\s*","");
        String userId = "1";
        String tradeType = "1";
        String favorDate = createTime;
        sql.append(" insert into D_POST_BAR_13(record_id,createtime,updatetime,isvalid,user_id,trade_type,favor_date,belong_qf,tixin,price_num) " +
                " VAlUES('"+recordId+"','"+createTime+"','"+createTime+"','1','"+userId+"','"+tradeType+"','"+favorDate+"','"+belongQf+"','"+tixin+"','"+priceNum+"')");
        System.out.println(sql);
        return this.commondao.update(sql.toString(), paramList);
    }
